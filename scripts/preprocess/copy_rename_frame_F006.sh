...
target_dir="/homes/chunchieh/brain/data_jpeg/20250110/X10xX10h_TH_L3p3_b2z2_p20xw_F006/raw_data_qua_frame"
...
for i in $(seq 1695 2218); do

  # Format source file number with leading zeros (e.g., 0649, 0999)
  printf -v src_number "%04d" "$i"
  # Source file path
  src_file="${src_dir}/X10xX10h_TH_L3p3_b2z2_p20xw_F006_sT_z${src_number}.jpeg"
